...
public class CouriersManActivity extends ComminBaseActivity {
	/**
	...
	private void initUI() {
		ids = new int[] { R.id.activity_couriers_main_noAllocation, R.id.activity_couriers_main_compeleted,
				R.id.activity_couriers_main_previous, R.id.activity_couriers_main_evaluate };
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			Builder alertDialog = new AlertDialog.Builder(CouriersManActivity.this);
	...
	private class MyLayoutListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			case R.id.activity_couriers_main_noAllocation:
				LogUtil.d(TAG, "待配送订单");
				Intent noAllocation = new Intent(CouriersManActivity.this, CouriersBaseActivity.class);
			...
			case R.id.activity_couriers_main_compeleted:
				...
				Intent compeleted = new Intent(CouriersManActivity.this, CouriersBaseActivity.class);
				compeleted.putExtra("STATUS", " 当日已完成订单");
				startActivity(compeleted);
				break;
			case R.id.activity_couriers_main_previous:
				LogUtil.d(TAG, "以往订单管理");
				Intent previou = new Intent(CouriersManActivity.this, CouriersBaseActivity.class);
				previou.putExtra("STATUS", "以往订单管理");
				startActivity(previou);
				break;
			case R.id.activity_couriers_main_evaluate:
				LogUtil.d(TAG, "查看评价");
				Intent evaluate = new Intent(CouriersManActivity.this, CouriersBaseActivity.class);
