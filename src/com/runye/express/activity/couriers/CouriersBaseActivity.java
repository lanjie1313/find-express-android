...
/**
 * 
 * @ClassName: CouriersBaseActivity
 * @Description: couriers activity 管理器
 * @author LanJie.Chen
...
public class CouriersBaseActivity extends Activity implements
	...
	private void initUI() {
		mPullToRefreshView = (PullToRefreshView) findViewById(R.id.activity_couriers_pullToRefreshView);
		mPullToRefreshView.setOnHeaderRefreshListener(this);
		mPullToRefreshView.setOnFooterRefreshListener(this);
		mListView = (ListView) findViewById(R.id.activity_couriers_listview);
		//
