...
public class VoicePlayClickListener implements View.OnClickListener {
	 ...
	 * @param chatType
	 */
	public VoicePlayClickListener(EMMessage message, ImageView v, ImageView iv_read_status, Context context,
	...
	public void onClick(View v) {
		...
		if (message.direct == EMMessage.Direct.SEND) {
			...
			if (file.exists() && file.isFile())
				...
				// "语音文件接收失败，是否下载此文件").putExtra("isCanceShow", true)
				// .putExtra("voicePath", voiceBody.localUrl);
				// activity.startActivityForResult(intent,
				// ChatActivity.REQUEST_CODE_DOWNLOAD_VOICE);
