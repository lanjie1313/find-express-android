 ...
 */
package com.runye.express.chat.adapter;
...
import com.runye.express.chat.activity.AlertDialog;
import com.runye.express.chat.activity.BaiduMapActivity;
import com.runye.express.chat.activity.ChatActivity;
import com.runye.express.chat.activity.ContextMenu;
...
public class MessageAdapter extends BaseAdapter {
	...
	private View createViewByMessage(EMMessage message, int position) {
		...
		case LOCATION:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(R.layout.chat_row_received_location,
					null) : inflater.inflate(R.layout.chat_row_sent_location, null);
		case IMAGE:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(R.layout.chat_row_received_picture,
					null) : inflater.inflate(R.layout.chat_row_sent_picture, null);

		case VOICE:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater
					.inflate(R.layout.chat_row_received_voice, null) : inflater.inflate(R.layout.chat_row_sent_voice,
					null);
		case VIDEO:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater
					.inflate(R.layout.chat_row_received_video, null) : inflater.inflate(R.layout.chat_row_sent_video,
					null);
		default:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(R.layout.chat_row_received_message,
					null) : inflater.inflate(R.layout.chat_row_sent_message, null);
		}
	}
	...
	private void handleVoiceMessage(final EMMessage message, final ViewHolder holder, final int position,
		...
		holder.iv.setOnClickListener(new VoicePlayClickListener(message, holder.iv, holder.iv_read_status, activity,
				activity, username));
		holder.iv.setOnLongClickListener(new OnLongClickListener() {
			@Override
			public boolean onLongClick(View v) {
