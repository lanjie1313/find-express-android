...
public class ChatHistoryAdapter extends ArrayAdapter<EMContact> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.chat_row_chat_history, parent, false);
		}
		...
		if (position % 2 == 0) {
			holder.list_item_layout.setBackgroundResource(R.drawable.chat_mm_listitem);
		} else {
			holder.list_item_layout.setBackgroundResource(R.drawable.chat_mm_listitem_grey);
		}
