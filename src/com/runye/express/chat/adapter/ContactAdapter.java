...
public class ContactAdapter extends ArrayAdapter<User> implements SectionIndexer {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (position == 0) {// 搜索框
			if (convertView == null) {
				convertView = layoutInflater.inflate(R.layout.chat_search_bar_with_padding, null);
			...
			if (username.equals(Constant.NEW_FRIENDS_USERNAME)) {
				...
				avatar.setImageResource(R.drawable.chat_new_friends_icon);
				...
				// 群聊item
				nameTextview.setText(user.getNick());
				avatar.setImageResource(R.drawable.chat_groups_icon);
			} else {
				nameTextview.setText(username);
				if (unreadMsgView != null)
					unreadMsgView.setVisibility(View.INVISIBLE);
				avatar.setImageResource(R.drawable.chat_default_avatar);
			}
		}
