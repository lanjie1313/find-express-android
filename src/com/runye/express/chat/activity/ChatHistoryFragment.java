...
public class ChatHistoryFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(R.layout.chat_fragment_conversation_history, container, false);
	}
	 ...
	 */
	public void refresh() {
		adapter = new ChatHistoryAdapter(getActivity(), R.layout.chat_row_chat_history, loadUsersWithRecentChat());
		listView.setAdapter(adapter);
		adapter.notifyDataSetChanged();
	}
