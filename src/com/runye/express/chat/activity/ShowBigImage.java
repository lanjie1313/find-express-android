...
public class ShowBigImage extends BaseActivity {
	...
	private int default_res = R.drawable.chat_default_avatar;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		default_res = getIntent().getIntExtra("default_image", R.drawable.chat_default_avatar);
	...
	private void downloadImage(final String remoteFilePath, final Map<String, String> headers) {
		...
		new Thread(new Runnable() {
			@Override
			public void run() {
				httpFileMgr.downloadFile(remoteFilePath, localFilePath, EMChatConfig.getInstance().APPKEY, null,
						headers, callback);
			}
		}).start();
