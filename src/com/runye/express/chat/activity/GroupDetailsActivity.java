...
public class GroupDetailsActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Drawable referenceDrawable = getResources().getDrawable(R.drawable.chat_smiley_add_btn);
		...
		adapter = new GridAdapter(this, R.layout.chat_grid, group.getMembers());
	...
	private class GridAdapter extends ArrayAdapter<String> {
		...
		public View getView(final int position, View convertView, final ViewGroup parent) {
			...
			if (position == getCount() - 1) {
				button.setText("");
				// 设置成删除按钮
				button.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.chat_smiley_minus_btn, 0, 0);
				...
				Drawable avatar = getResources().getDrawable(R.drawable.chat_default_avatar);
					...
					public void onClick(View v) {
						if (isInDeleteMode) {
							...
							if (EMChatManager.getInstance().getCurrentUser().equals(username)) {
								startActivity(new Intent(GroupDetailsActivity.this, AlertDialog.class).putExtra("msg",
										"不能删除自己"));
								return;
							}
